...
curl http://${DOWNLOAD_HOST}/devel/candidates/jboss/devstudio/devsuite-1.4.1/rpms/signed/SHA256SUM -o rh-devsuite-1.4.1-1.el7.x86_64.rpm.sha256
sha256sum --check rh-devsuite-1.4.1-1.el7.x86_64.rpm.sha256 || exit 1
