...
sha256sum rh-devsuite-2.3.0-1.el7.x86_64.rpm > rh-devsuite-2.3.0-1.el7.x86_64.rpm.sha256
sha256sum rh-devsuite-debuginfo-2.3.0-1.el7.x86_64.rpm > rh-devsuite-debuginfo-2.3.0-1.el7.x86_64.rpm.sha256
popd
pushd $(pwd)/rpmbuild/SRPMS/
sha256sum rh-devsuite-2.3.0-1.el7.src.rpm > rh-devsuite-2.3.0-1.el7.src.rpm.sha256
popd
